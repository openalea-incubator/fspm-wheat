...
class ElongWheatFacade(object):
    ...
    def __init__(self, shared_mtg, delta_t,
        ...
        phytoT = pd.read_csv(os.path.join(fspmwheat.__path__[0], 'phytoT.csv'))
                    ...
                    for mtg_organ_vid in self._shared_mtg.components_iter(mtg_metamer_vid):
                        ...
                        for mtg_element_vid in self._shared_mtg.components_iter(mtg_organ_vid):
                            ...
                            if set(mtg_element_properties).issuperset(simulation.ELEMENT_INPUTS):
                                ...
                                elif mtg_organ_label == 'internode' and not mtg_element_properties[
                                    'is_growing']:  # WARNING: this algo won't copy previous internode length for a phytomer without internode
