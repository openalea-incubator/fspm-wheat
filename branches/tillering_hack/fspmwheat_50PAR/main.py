...
def main(stop_time, forced_start_time=0, run_simu=True, run_postprocessing=True, generate_graphs=True, run_from_outputs=False, opt_croiss_fix=False,
    ...
    if run_simu:
        ...
        for t_caribu in range(start_time, stop_time, caribu_ts):
            ...
            caribu_facade_.run(energy=PARi/2, DOY=DOY, hourTU=hour, latitude = 48.85, sun_sky_option = 'sky', heterogeneous_canopy=heterogeneous_canopy)
...
if __name__ == '__main__':
    main(1900, forced_start_time=0, run_simu=True, run_postprocessing=True, generate_graphs=True, run_from_outputs=False, opt_croiss_fix=False,
