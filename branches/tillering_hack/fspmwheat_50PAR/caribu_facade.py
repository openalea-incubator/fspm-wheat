...
"""
    Information about this versioned file:
        ...
        $LastChangedDate: 2019-03-28 10:20:08 +0100 (jeu., 28 mars 2019) $
        $LastChangedRevision: 152 $
        $URL: https://subversion.renater.fr/fspm-wheat/branches/tillering_hack/fspmwheat/caribu_facade.py $
        $Id: caribu_facade.py 152 2019-03-28 09:20:08Z mngauthier $
"""
...
class CaribuFacade(object):
    ...
    def run(self, sun_sky_option='mix', energy=1, DOY=1, hourTU=12, latitude=48.85, diffuse_model='soc', azimuts=4, zenits=5, heterogeneous_canopy=False):
        ...
        :param int hourTU: Hour to be used for solar sources (TU)
    ...
    def _initialize_model(self, energy, diffuse_model, azimuts, zenits, DOY, hourTU, latitude, heterogeneous_canopy):
        ...
        :return: caribu scene(s) initialised
    ...
    def _create_heterogeneous_canopy(self, nplants=50, var_plant_position=0.03, var_leaf_inclination=0.157, var_leaf_azimut=1.57, var_stem_azimut=0.157):
        ...
        :return: duplicated heterogenous scene
        :rtype: openalea.plantgl.all.Scene
        """
