...
# Define default plant density (culm m-2)
    ...
    if run_simu:
        ...
        # Create adel_wheat obj and empty mtg
...
if __name__ == '__main__':
    main(2000, forced_start_time=0, run_simu=False, run_postprocessing=True, generate_graphs=True, run_from_outputs=False,
         ...
         N_fertilizations={'constant_Conc_Nitrates': 5},
