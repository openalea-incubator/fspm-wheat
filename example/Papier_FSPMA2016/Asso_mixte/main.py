...
def main(stop_time, run_simu=True, make_graphs=True):
    if run_simu:
        ...
        forced_max_protein_elements = set(((1,'MS',1,'blade', 'LeafElement1'), (1,'MS',2,'blade', 'LeafElement1'), (1,'MS',3,'blade', 'LeafElement1'),
                                           (4,'MS',1,'blade', 'LeafElement1'), (4,'MS',2,'blade', 'LeafElement1'), (4,'MS',3,'blade', 'LeafElement1')))
        ...
        for t_senescwheat in xrange(start_time, stop_time, senescwheat_ts):
            ...
            for t_growthwheat in xrange(t_senescwheat, t_senescwheat + senescwheat_ts, growthwheat_ts):
                ...
                for t_farquharwheat in xrange(t_growthwheat, t_growthwheat + growthwheat_ts, farquharwheat_ts):
                    ...
                    aggregated_PARa = calculate_PARa_from_df(Eabs_df[Eabs_df['t']==t_farquharwheat], PARi, multiple_sources=True, ratio_diffus_PAR=ratio_diffus_PAR)
